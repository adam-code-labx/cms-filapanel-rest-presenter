...
namespace App\Api\Resources\Users;
...
class UserResourceController extends ResourceController
{
    ...
    {
        return [
            'user' => \XtendPackages\RESTPresenter\Resources\Users\Presenters\User::class,
			'profile' => \XtendPackages\RESTPresenter\Resources\Users\Presenters\Profile::class,
        ];
    }
}
